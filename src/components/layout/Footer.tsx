    ...
    <footer className="relative overflow-hidden bg-[#0f172a]">
      ...
      <div className="absolute -top-1 left-0 right-0 z-10">
        <svg viewBox="0 0 1440 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full" preserveAspectRatio="none">
          <path d="M0 0H1440V10C1440 26.5685 1426.57 40 1410 40H30C13.4315 40 0 26.5685 0 10V0Z" fill="#f8fafc" />
        </svg>
      </div>

      <div className="relative mx-auto max-w-5xl px-4 pb-10 pt-20 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 flex gap-2">
              {[
                ...
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/[0.05] bg-white/[0.03] text-slate-500 transition-all duration-300 hover:border-emerald-500/20 hover:bg-emerald-500/10 hover:text-emerald-400"
                  aria-label={label}
                >
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-white/[0.05] pt-6 sm:flex-row">
          ...
          <div className="flex gap-5">
            <a href="#" className="text-[11px] text-slate-600 transition-colors hover:text-slate-400">
              Aviso de privacidad
            </a>
            <a href="#" className="text-[11px] text-slate-600 transition-colors hover:text-slate-400">
