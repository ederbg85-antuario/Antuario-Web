...
const fills: Record<string, { top: string; bottom: string }> = {
  'light-to-dark': { top: '#f1f5f9', bottom: '#0f0f0f' },
  'dark-to-light': { top: '#0f0f0f', bottom: '#f1f5f9' },
  'light-to-alt':  { top: '#f1f5f9', bottom: '#f8fafc' },
  'alt-to-light':  { top: '#f8fafc', bottom: '#f1f5f9' },
  'alt-to-dark':   { top: '#f8fafc', bottom: '#0f0f0f' },
  'dark-to-alt':   { top: '#0f0f0f', bottom: '#f8fafc' },
  ...
  'white-to-dark': { top: '#f1f5f9', bottom: '#0f0f0f' },
}
