...
export default function CTASection() {
  return (
    <section id="contacto" className="relative overflow-hidden bg-[#0f172a] px-4 py-24 sm:px-6 md:py-32 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a
              ...
              className="btn-shine group inline-flex items-center gap-2 overflow-hidden rounded-xl bg-white px-5 py-2.5 text-[13px] font-semibold text-[#0f172a] shadow-[0_4px_20px_rgba(255,255,255,0.15)] transition-all duration-300 hover:shadow-[0_8px_30px_rgba(255,255,255,0.25)] hover:scale-[1.02]"
            >
