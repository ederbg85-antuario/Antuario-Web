          ...
          <div className="pb-20 sm:pb-28">
            ...
            >
              <a
                ...
                className="btn-shine group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-xl bg-[#1A1D2B] px-6 py-3 text-[13px] font-semibold text-white shadow-[0_4px_20px_rgba(0,0,0,0.15)] transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.25)] hover:scale-[1.02]"
              >
              ...
              <a
                href="#plataforma"
                className="group inline-flex items-center justify-center gap-2 rounded-xl border border-black/[0.08] bg-white/60 px-5 py-3 text-[13px] font-semibold text-text-primary shadow-soft backdrop-blur-md transition-all duration-300 hover:border-black/12 hover:bg-white/80"
              >
