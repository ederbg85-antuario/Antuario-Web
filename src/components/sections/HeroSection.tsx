              ...
              <span className="relative inline-block h-[28px] w-[160px] overflow-hidden sm:w-[220px]">
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="absolute left-0 top-0 whitespace-nowrap rounded-full bg-[#0f0f0f]/[0.07] px-3 py-0.5 text-[14px] font-bold text-[#0f0f0f] ring-1 ring-[#0f0f0f]/10 backdrop-blur-sm"
                  >
          ...
          >
            ...
            >
              <div className="overflow-hidden rounded-2xl bg-[#1a1a1a]">
                <div className="flex items-center gap-2 border-b border-white/[0.05] bg-[#1a1a1a] px-4 py-2.5">
