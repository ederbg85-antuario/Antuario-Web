...
const activos = [
  {
    ...
    color: 'text-cyan-500',
    bg: 'bg-cyan-50',
    glowColor: 'group-hover:shadow-[0_8px_40px_rgba(6,182,212,0.12)]',
  ...
  },
  {
    ...
    bg: 'bg-violet-50',
    glowColor: 'group-hover:shadow-[0_8px_40px_rgba(167,139,250,0.12)]',
    accentGradient: 'from-violet-500/20 to-transparent',
  },
  {
    icon: Target,
    ...
    bg: 'bg-amber-50',
    glowColor: 'group-hover:shadow-[0_8px_40px_rgba(245,158,11,0.12)]',
...
export default function ActivosSection() {
  return (
    <section id="activos" className="relative overflow-hidden bg-slate-50 px-4 py-24 sm:px-6 md:py-32 lg:px-8">
      {/* Background accents */}
      <div className="pointer-events-none absolute right-0 top-0 h-[400px] w-[400px] animate-blob-slow rounded-full bg-cyan-500/[0.03] blur-[150px]" />
      <div className="pointer-events-none absolute bottom-0 left-1/4 h-[350px] w-[350px] animate-float-slow rounded-full bg-violet-500/[0.02] blur-[130px]" />
      ...
      <div className="relative mx-auto max-w-6xl" style={{ perspective: '1200px' }}>
        ...
        >
          <p className="mb-3 text-sm font-bold uppercase tracking-widest text-cyan-500">
            Tus activos digitales
          </p>
          <h2 className="mb-5 font-heading text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">
        ...
        <div className="grid gap-8 sm:grid-cols-3">
          {activos.map((activo, i) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-3xl border border-slate-200/60 bg-white p-8 shadow-card-3d transition-shadow duration-400 ${activo.glowColor}`}
            >
              ...
              <motion.div
                ...
                className={`relative mb-6 inline-flex rounded-3xl ${activo.bg} p-4 shadow-soft`}
              >
                <activo.icon className={`h-7 w-7 ${activo.color}`} />
              </motion.div>
              <h3 className="relative mb-3 text-xl font-bold text-slate-900">{activo.title}</h3>
