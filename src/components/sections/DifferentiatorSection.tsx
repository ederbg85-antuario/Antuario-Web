...
const columns = [
  {
    ...
    icon: X,
    iconBg: 'bg-antuario-red/10',
    iconColor: 'text-antuario-red',
    bg: 'bg-gradient-to-b from-antuario-red/[0.03] to-white border-antuario-red/10',
    textColor: 'text-text-secondary',
    labelColor: 'text-antuario-red',
  ...
  },
  {
    ...
    bg: 'bg-gradient-to-b from-antuario-green/[0.06] to-white border-antuario-green/20',
    textColor: 'text-text-primary',
    labelColor: 'text-antuario-green',
  ...
  },
  {
    ...
    iconBg: 'bg-antuario-green/10',
    iconColor: 'text-antuario-green',
    bg: 'bg-gradient-to-b from-antuario-cyan/[0.04] to-white border-antuario-green/15',
    textColor: 'text-text-primary',
    labelColor: 'text-antuario-green-dark',
        ...
        <div className="grid gap-8 sm:grid-cols-3" style={{ perspective: '1000px' }}>
          {columns.map((col, i) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-[28px] border p-9 shadow-card-3d transition-all duration-400 hover:shadow-card-3d-hover ${col.bg} ${col.highlight ? 'ring-1 ring-antuario-green/20' : ''}`}
            >
              {/* Icon */}
              ...
              <p className={`text-base leading-relaxed ${col.textColor}`}>
                {col.copy}
              </p>
