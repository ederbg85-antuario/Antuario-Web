    ...
    <SectionWrapper>
      <div className="mb-16 text-center">
        ...
        <h2 className="mb-5 font-heading text-3xl font-bold text-slate-900 sm:text-4xl">
          ...
          <span className="text-emerald-500">escalar con sistema</span>
        </h2>
      </div>
      ...
      <div className="mx-auto grid max-w-4xl gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-[2rem] border border-accent-green/15 bg-accent-green/5 p-8 shadow-card">
          <h3 className="mb-6 flex items-center gap-2.5 text-lg font-bold text-emerald-500">
        ...
        {/* Not for */}
        <div className="rounded-[2rem] border border-slate-200/60 bg-white p-8 shadow-card">
          <h3 className="mb-6 flex items-center gap-2.5 text-lg font-bold text-slate-400">
