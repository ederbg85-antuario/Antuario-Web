...
const differentiators = [
  { text: 'Plataforma propia con IA integrada', color: 'bg-emerald-400' },
  { text: 'Accountability real sobre resultados', color: 'bg-violet-400' },
  { text: 'Visibilidad en tiempo real 24/7', color: 'bg-cyan-400' },
  { text: 'Para dueños, no para analistas', color: 'bg-amber-400' },
]
...
function HomeHero() {
  return (
    <section className="relative overflow-hidden bg-[#0f172a] px-4 pb-0 pt-24 sm:px-6 sm:pt-32 lg:px-8">
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        >
          <div className="inline-flex items-center gap-2.5 rounded-full border border-white/[0.07] bg-white/[0.04] px-4 py-2 backdrop-blur-md">
        ...
        <motion.p
          ...
          className="mx-auto mb-8 max-w-2xl text-[15px] leading-relaxed text-slate-400 sm:text-[17px]"
        >
        ...
        >
          {differentiators.map((d, i) => (
            <span
              key={i}
              className="flex items-center gap-2 rounded-full border border-white/[0.06] bg-white/[0.03] px-3.5 py-1.5 text-[12px] font-medium text-slate-400"
            >
        ...
        >
          <a
            ...
            className="btn-shine group inline-flex items-center gap-2 overflow-hidden rounded-xl bg-white px-6 py-3 text-[14px] font-semibold text-slate-900 shadow-[0_4px_20px_rgba(255,255,255,0.12)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_8px_30px_rgba(255,255,255,0.2)]"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center gap-2 rounded-xl border border-white/[0.07] bg-white/[0.04] px-6 py-3 text-[14px] font-semibold text-white/65 transition-all duration-300 hover:border-white/[0.12] hover:bg-white/[0.07] hover:text-white"
          >
            Ver el Dashboard
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {products.map((product, i) => (
            ...
            >
              <Link
                href={product.href}
                className={`group relative flex h-full flex-col rounded-3xl border border-slate-200/60 bg-white/80 p-7 shadow-card backdrop-blur-sm transition-all duration-400 hover:-translate-y-1.5 hover:shadow-card-hover ${product.borderHover}`}
              >
                {/* Top accent gradient */}
                <div className={`pointer-events-none absolute inset-x-0 top-0 h-32 rounded-t-3xl bg-gradient-to-b ${product.accentColor} opacity-0 transition-opacity duration-400 group-hover:opacity-100`} />

                {/* Badge */}
                <span className={`mb-5 inline-flex self-start rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-wider ${product.badgeColor}`}>
                  {product.badge}
                </span>
                ...
                {/* Title & subtitle */}
                <h3 className="mb-1.5 font-heading text-[20px] font-extrabold tracking-tight text-slate-900">
                  {product.title}
                </h3>
                ...
                {/* Description */}
                <p className="mb-5 flex-1 text-[14px] leading-relaxed text-slate-500">
                  {product.description}
                </p>
    ...
    <section className="relative overflow-hidden bg-slate-50 px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <h2 className="font-heading text-[28px] font-extrabold tracking-tight text-slate-900 sm:text-[34px]">
        ...
        >
          {profiles.map((p, i) => (
            <span
              key={i}
              className="flex items-center gap-2 rounded-full border border-slate-200/60 bg-white/80 px-4 py-2 text-[13px] font-medium text-slate-500 shadow-soft backdrop-blur-sm"
            >
              <span>{p.emoji}</span>
              {p.label}
            </span>
        ...
        <motion.div
          ...
          className="mx-auto max-w-2xl rounded-3xl border border-slate-200/60 bg-white/70 p-6 text-center shadow-card backdrop-blur-sm"
        >
          <p className="text-[14px] leading-relaxed text-slate-500">
            <span className="font-bold text-slate-900">Compromiso mínimo de 12 meses.</span>{' '}
        ...
        <div className="space-y-4">
          {items.map((item, i) => (
            <motion.div
              ...
              className={`glass-card-dark rounded-3xl p-6 pl-7 border-l-4 ${item.color}`}
            >
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        >
          ...
          <p className="mx-auto mb-10 max-w-2xl text-[15px] leading-relaxed text-slate-400">
            Platícanos sobre tu negocio y te mostramos cómo Antuario puede ayudarte a
            tener claridad y resultados reales en tu área comercial. Sin compromiso.
          </p>
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn-shine group inline-flex items-center gap-2 overflow-hidden rounded-xl bg-white px-6 py-3 text-[13px] font-semibold text-slate-900 shadow-[0_4px_20px_rgba(255,255,255,0.12)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_8px_30px_rgba(255,255,255,0.2)]"
            >
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" />
              </svg>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 rounded-xl border border-white/[0.06] bg-white/[0.03] px-6 py-3 text-[13px] font-semibold text-white/70 backdrop-blur-md transition-all duration-300 hover:border-white/[0.1] hover:bg-white/[0.06]"
            >
