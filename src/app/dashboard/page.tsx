...
const metrics = [
  { icon: TrendingUp, color: 'text-emerald-500', value: 'Tiempo real', label: 'Datos siempre actualizados' },
  { icon: MessageSquare, color: 'text-cyan-500', value: '24/7', label: 'Visibilidad total' },
  { icon: FileText, color: 'text-violet-500', value: '4', label: 'Módulos integrados' },
  { icon: Layers, color: 'text-amber-500', value: '1', label: 'Solo plataforma' },
]
    ...
    <section className="relative overflow-hidden bg-background px-4 pb-0 pt-24 sm:px-6 sm:pt-28 lg:px-8">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <div className="pointer-events-none absolute -inset-8 rounded-[40px] bg-gradient-to-br from-cyan-500/15 via-emerald-500/10 to-violet-500/10 blur-3xl" style={{ zIndex: -1 }} />
            ...
            >
              <div className="overflow-hidden rounded-3xl bg-[#1e293b]">
                <div className="flex items-center gap-2 border-b border-white/[0.04] bg-[#0f172a] px-4 py-2.5">
                  ...
                  <div className="ml-3 flex flex-1 items-center gap-1.5 rounded-lg bg-white/[0.04] px-3 py-1">
                    ...
                    <span className="text-[10px] text-slate-600">app.antuario.mx/vision-maestra</span>
                  </div>
                </div>
            ...
            >
              ...
              <span className="text-[11px] font-semibold text-slate-900">Datos en tiempo real</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {metrics.map((m, i) => (
            <motion.div
              ...
              className="flex flex-col items-center gap-2 rounded-2xl border border-slate-200/60 bg-white/80 p-5 text-center shadow-soft backdrop-blur-sm"
            >
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {modules.map((mod, i) => (
            <motion.div
              ...
              className={`group rounded-3xl border ${mod.borderColor} bg-white/80 p-8 shadow-card backdrop-blur-sm transition-all duration-400 hover:-translate-y-1.5 hover:shadow-card-hover`}
            >
              ...
              <h3 className="mb-3 font-heading text-[20px] font-extrabold tracking-tight text-slate-900">
                {mod.title}
              </h3>
    ...
    <section className="relative overflow-hidden bg-[#0f172a] px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
      ...
      <div className="relative mx-auto max-w-6xl">
        <motion.div
          ...
          className="mb-14 text-center"
        >
          <p className="mb-3 text-[12px] font-bold uppercase tracking-widest text-cyan-500">
            Antuario Dashboard
          </p>
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {screenshots.map((shot, i) => (
            <motion.div
              ...
              className="group overflow-hidden rounded-3xl border border-white/[0.08] bg-[#1e293b] shadow-[0_8px_40px_rgba(0,0,0,0.4)] transition-all duration-400 hover:-translate-y-1.5"
            >
              {/* Browser chrome */}
              <div className="flex items-center gap-2 border-b border-white/[0.04] bg-[#0f172a] px-4 py-2.5">
                <div className="flex gap-1.5">
                ...
                <span className="ml-2 text-[9px] text-slate-600">{shot.url}</span>
              </div>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={shot.src}
              ...
              <div className="px-4 py-3">
                <p className="text-[11px] font-medium text-slate-500">{shot.label}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        >
          ...
          <p className="mx-auto mb-10 max-w-2xl text-[15px] leading-relaxed text-slate-400">
            Contacta con nuestro equipo de ventas. Incluye una demo en vivo del Dashboard para que veas
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Link
              href="/agente-ia"
              className="group inline-flex items-center gap-2 rounded-xl border border-white/[0.07] bg-white/[0.04] px-6 py-3 text-[13px] font-semibold text-white/80 backdrop-blur-md transition-all duration-300 hover:border-white/12 hover:bg-white/[0.06]"
            >
