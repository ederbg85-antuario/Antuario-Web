...
const professionalServiceSchema = { '@context': 'https://schema.org', '@type': 'ProfessionalService', '@id': siteConfig.url + '/#agencia', name: 'Antuario', alternateName: 'Antuario Marketing Digital', description: 'Agencia de marketing digital en CDMX. Soluciones de marketing digital a la medida.', url: siteConfig.url, logo: siteConfig.url + '/logos/logotype.svg', image: siteConfig.url + '/opengraph-image', telephone: siteConfig.phone, email: siteConfig.email, priceRange: '$$$', address: { '@type': 'PostalAddress', addressLocality: 'Ciudad de México', addressRegion: 'CDMX', addressCountry: 'MX' }, areaServed: ['MX', 'Latinoamérica'], sameAs: [siteConfig.social.linkedin, siteConfig.social.instagram] }
